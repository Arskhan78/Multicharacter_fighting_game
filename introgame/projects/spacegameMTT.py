...
while run: 
    ...
    if screen_index == 1:
        ...
        controltext_player_1 = baby_font.render("For Player on the RIGHT, Press TAB to move up and LSHIFT to move down", False, white)
        screen.blit(controltext_player_1, (205, 400))

        controltext_player_2 = baby_font.render("For Player on the RIGHT, Press UP-ARROW to move up and DOWN-Arrow to move down", False, white)
        screen.blit(controltext_player_1, (200, 250))
